...
const FLOW_STATES = {
  ...
  PASTE_PRODUCT_REFERENCE: 'PASTE_PRODUCT_REFERENCE',
  VERIFY_PRODUCT_ATTACHMENT: 'VERIFY_PRODUCT_ATTACHMENT',
  INJECT_UNIFIED_PROMPT: 'INJECT_UNIFIED_PROMPT',
  SUBMIT: 'SUBMIT',
...
const RETRY_DELAYS = {
  ...
  PASTE_PRODUCT_REFERENCE: [1000, 2000, 5000],
  VERIFY_PRODUCT_ATTACHMENT: [1000, 2000, 5000],
  INJECT_UNIFIED_PROMPT: [1000, 2000, 5000],
  SUBMIT: [2000, 5000, 10000],
...
const STATE_TIMEOUTS = {
  ...
  UPLOAD_IMAGE:        30000,
  PASTE_PRODUCT_REFERENCE: 30000,
  VERIFY_PRODUCT_ATTACHMENT: 30000,
  INJECT_UNIFIED_PROMPT: 15000,
  SUBMIT: 60000,
...
const STATE_LABELS = {
  ...
  PASTE_PRODUCT_REFERENCE: '📋 Dán ảnh sản phẩm vào composer',
  VERIFY_PRODUCT_ATTACHMENT: '✅ Xác nhận thumbnail sản phẩm',
  INJECT_UNIFIED_PROMPT: '✏️ Nhập prompt ảnh chung',
  SUBMIT: '🚀 Gửi tạo đúng một ảnh',
