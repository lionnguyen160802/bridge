...
const FLOW_STATES = {
  ...
  ATTACH_PRODUCT_REFERENCE: 'ATTACH_PRODUCT_REFERENCE',
  GENERATE_UNIFIED_IMAGE: 'GENERATE_UNIFIED_IMAGE',
...
const RETRY_DELAYS = {
  ...
  ATTACH_PRODUCT_REFERENCE: [1000, 2000, 5000],
  GENERATE_UNIFIED_IMAGE: [2000, 5000, 10000],
...
const STATE_TIMEOUTS = {
  ...
  UPLOAD_IMAGE:        30000,
  ATTACH_PRODUCT_REFERENCE: 30000,
  GENERATE_UNIFIED_IMAGE: 60000,
...
const STATE_LABELS = {
  ...
  ATTACH_PRODUCT_REFERENCE: '📎 Gắn ảnh sản phẩm vào câu lệnh',
  GENERATE_UNIFIED_IMAGE: '🎨 Tạo một ảnh chung',
